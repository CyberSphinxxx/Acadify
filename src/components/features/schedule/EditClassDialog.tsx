...
interface EditClassDialogProps {
    ...
    onSave: (data: z.infer<typeof formSchema>, initialSessions: ClassSession[]) => Promise<void>
}

export function EditClassDialog({ open, onOpenChange, course, onSave }: EditClassDialogProps) {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        setIsLoading(true)
        try {
            await onSave(values, course.sessions)
            onOpenChange(false)
        } catch (error) {
            console.error(error)
        } finally {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px] max-h-[80vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Update class details and sessions.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
